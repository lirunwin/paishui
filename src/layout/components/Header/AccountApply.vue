  ...
  >
    <el-tabs v-model="activeTab">
      <el-tab-pane label="历史申请记录" name="history">
        ...
        />
        <el-button type="primary" size="small" @click="historyList"
          >查询</el-button
        >
        <el-button type="primary" size="small" @click="toggleAccountApplyTab"
          >账号申请</el-button
        >
        <el-table
          :data="applyHistory"
        ...
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="申请信息" name="applyInfo">
            <el-row class="custom-row">
              ...
              ><span>{{ detailInfo.applyername }}</span>
            </el-row>
            <el-row class="custom-row">
