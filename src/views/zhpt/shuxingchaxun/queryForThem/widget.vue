<template>
  ...
  <div style="padding: 0 8px;overflow-y:auto;" class="i-scrollbar">
    ...
    >
      ...
      >
      <el-button size="mini" type="primary" style="width:40%;display:inline-block;margin-top:8px;" @click="clearAll"
        >清空</el-button
      >
    </tf-legend>
...
export default {
  ...
  methods: {
    ...
    gotoGeometry(geometry) {
      ...
      this.mapView
        .getView()
        .animate({ center: [(extent[0] + extent[2]) / 2, (extent[1] + extent[3]) / 2] }, { zoom: 20 })
    }
  },
  destroyed() {
    this.clearAll()
