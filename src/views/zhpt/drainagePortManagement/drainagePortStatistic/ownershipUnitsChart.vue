...
export default {
    ...
    data(){
        return{
            portTypeChart:null,
            colorList:['#3AA1FF','#36CBCB','#4ECB73','#FBD437'],
            result:null,
            isShowTable:false,
            tableData:[],
            tabelColumn:[],
    ...
    methods:{
        ...
        exportTable(){
            let wb = XLSX.utils.table_to_book(document.querySelector("#ownershipUnitsTable"));
        ...
        exportChart(){
            ...
            html2canvas(this.$refs.chart).then(function (canvas) {
                ...
                creatIMg.download = "按权属单位统计图表.png"; // 设置下载的文件名，
