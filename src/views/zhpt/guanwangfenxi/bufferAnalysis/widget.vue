<template>
  <div class="panel-container">
    ...
    <div class="op-box">
      <el-button type="primary" size="small" style="width:100%" @click="doQuery_new" :loading="queryStatus"
        >开始查询</el-button
      >
    </div>
    <!-- 查询结果 -->
  ...
  methods: {
    ...
    getBufferFeature(drawFeature) {
      ...
      if (this.drawType == 'point') {
        fea = turf.point(geometry.getCoordinates())
      } // turf的点要素
      else if (this.drawType == 'line') {
        fea = turf.lineString(geometry.getCoordinates())
      } // turf的线要素
