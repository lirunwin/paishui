				...
				<div class="flexImage">
					...
					<div class="flexInfo demo-image__preview">
						<div style="float:left;">
							<el-image v-for="(item,index) in dangerRecordData.filelist" :key="index"
								style=""
								:src="item" :preview-src-list="dangerRecordData.filelist">
							</el-image>
						</div>
						<div>
		...
		<tf-table-legend label="隐患消除登记" isopen="false" style="margin-top: 8px;">
			<div style="width: 100%; display: flex; flex-wrap: wrap;"
				...
				<div class="flexDivMax">
					...
					<div class = 'flexInfo'>
						<el-input v-model="item.notes" placeholder="消除隐患情况说明" 
