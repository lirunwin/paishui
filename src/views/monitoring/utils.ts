...
/**设备档案管理 */
export const settingArchiveCols: Partial<ElTableColumn>[] = [
  { type: 'selection', width: '50px' },
  { type: 'index', label: '序号' },
...
/**指标标准被指 */
export const settingStandardCols: Partial<ElTableColumn>[] = [
  { type: 'selection', width: '50px' },
  { type: 'index', label: '序号' },
...
/**指标标准被指 -参数*/
export const settingStandardParamCols: Partial<ElTableColumn>[] = [
  { type: 'selection', width: '50px' },
  { type: 'index', label: '序号' },
...
/**监测点管理 */
export const settingPointCols: Partial<ElTableColumn>[] = [
  { type: 'selection', width: '50px' },
  { type: 'index', label: '序号' },
...
/**图标管理 */
export const settingIconCols: Partial<ElTableColumn>[] = [
  { type: 'selection', width: '50px' },
  { type: 'index', label: '序号' },
