<template>
  <div style="height:100%;width:100%;position: absolute;">
    <div class="app-container" style="height:100%;width:100%">
      ...
      <div class="handerUser">
        ...
        <div class="btn_box">
          ...
          <el-button type="primary" size="small" :disabled="multipleSelection.length === 0" @click="roleBinding"
            >角色绑定</el-button
          >
          ...
          <el-button type="primary" size="small" :disabled="multipleSelection.length === 0" @click="resetPwd"
            >重置密码</el-button
          >
          <el-button type="primary" size="small" :disabled="existEnableFlag" @click="handleAuthOperation('enable')"
            >启用</el-button
          >
          <el-button type="primary" size="small" :disabled="existDisableFlag" @click="handleAuthOperation('disable')"
            >禁用</el-button
          >
          <el-button type="primary" size="small" :disabled="existLockFlag" @click="handleAuthOperation('unlock')"
            >解锁</el-button
          >
    ...
    <!-- <el-dialog v-dialogDrag title="启用设置" :visible.sync="enable.enableSetting" width="500px">
      <input-item type="text" placeholder title="用户姓名：" custom-style="display: inline-block; width: 80%; line-height: 32px;" :value="enable.enableName" :max-length="50" :disabled="true" :required="false" />
...
export default class UserRights extends Vue {
  ...
  roleBinding() {
    ...
    if (currentUsers.length !== 0) {
      ...
      this.copyRole = []
      console.log(
        '角色：' + JSON.stringify(this.roleId) + ' 用户：' + JSON.stringify(this.userId) + '  ' + this.role.roleName
      )
