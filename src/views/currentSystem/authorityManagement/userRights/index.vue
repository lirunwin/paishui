  ...
  <div>
    ...
    <el-dialog v-dialogDrag :title="dialogTitle" :visible.sync="dialogVisible" width="800px">
      <div class="dialog_style">
        <MergeUser v-if="dialogVisible" ref="ruleForm" :data="editData" :company="departments" :options-role="role.optionsRole" @remind="remind" />
      </div>
    ...
    <el-dialog v-dialogDrag title="角色权限绑定" :visible.sync="role.roleBind" width="500px" height="300px">
      ...
      />-->
        ...
        <SelectMultiple placeholder="请选择" title="角色：" nominate="roleId" custom-style="display: inline-block; width: 80%; line-height: 32px;" :value="roleId" :disabled="false" :required="false" :filterable="true" :options="role.optionsRole" @changeSelectMultipleValue="changeSelectMultipleValue" />
      </div>
...
import { getUserList, deleteUser, roleBind, setUserUnlock, getCompany, getRoleList, editUser, batchUser, initialPwd, downloadTemplate, auditUser, setUserLock, setUserDisable, setUserEnable, getFiles } from '@/api/base'
