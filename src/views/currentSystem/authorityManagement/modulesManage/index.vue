...
import { querySystemList, addNewSystem, editSystem, delSystem, queryMenuList, addNewMenu, editMenu, delMenu } from '@/api/base'
const systemCols = [
  {
    label: '序号',
    prop: 'order',
...
export default {
  ...
  data() {
    return {
      querySystemList, addNewSystem, editSystem, delSystem, queryMenuList, addNewMenu, editMenu, delMenu,
      systemCols,
      menuCols,
      systemForm: {
        sysname: '',
      ...
      menuFormRule: {
        ...
        sysId: [
          { required: true, message: '所属系统是必填项！', trigger: 'blur' }
        ],
        meta: [
          { required: true, message: '元属性是必填项！', trigger: 'blur' }
        ],
        label: [
